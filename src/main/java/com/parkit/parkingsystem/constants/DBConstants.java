...
public class DBConstants {
    ...
    public static final String UPDATE_TICKET_FOR_ENTRY = "update ticket set PARKING_NUMBER=?, PRICE=?, IN_TIME=?, OUT_TIME=?, DISCOUNT=? where ID=?";
    public static final String UPDATE_TICKET_FOR_EXIT = "update ticket set PRICE=?, OUT_TIME=? where ID=?";
